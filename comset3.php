  ...
  <?php require 'temp.php'; ?>
                        ...
                        <!-- start product -->
                           ...
                           while ($meResultt = mysql_fetch_assoc($meQueryy))
                           {
                              ...
                              if(strcmp($meResultt['Det_TYPE'],'3')==0){
                               ?>
                                  ...
                                  <div class="thumbnail">
                                      <img src="img/<?php echo $meResultt['Det_IMG']; ?>">
                                          <div class="caption">
                                              ...
                                              <a href="repair.php" class="btn btn-danger" role="button">BUY NOW</a>
                                              <!-- <a href="#" data-toggle="modal" data-target="#myDetail" class="btn btn-warning" role="button" value="ssss">DETAIL </a> -->
